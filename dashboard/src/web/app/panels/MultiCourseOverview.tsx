...
import type { ConsoleStateView, CourseOverview, CourseOverviewComponent } from '../../view'
import { fmtPct } from '../../view'
      ...
      <div className="tc-cov__rows">
        {rows.map((r) => (
          ...
          >
            ...
            <span
              className="tc-cov__phase"
              title={`阶段：${PHASE_LABEL[r.phase.phase] ?? r.phase.phase}`}
            >
