/** evalboard-stats.test.ts ↔ dashboard/src/evalboard/stats.ts（§2.4 唯一口径）。 */
import { describe, expect, it } from 'bun:test'
import { deriveMetrics, flipRate, mddPaired, mddUnpaired, windowAgg } from '../src/evalboard/stats'
import type { EvalGameRow } from '../src/evalboard/store'
