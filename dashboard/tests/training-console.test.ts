/**
 * training-console.test.ts — dashboard/src/console 的单元测试。
 *
...
// 路径一律取 core/paths 常量（绝对路径，与 cwd 无关）：测试文件搬到
// dashboard/tests/ 后，import.meta.dir 推导出来的相对深度会整体错一层。
const REAL_CONFIG = CONFIG_PATH
const REAL_STATE = consoleStatePath()
...
const render = await import('../src/web/render')
const view = await import('../src/web/view')
