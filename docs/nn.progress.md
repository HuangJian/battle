...
| §149 | docs/nn/remote-transport.md §49 | 第三块盘 `battle.cloudflared.ipynb` 明确退役（不装 bun）：零逻辑指路牌 + `SystemExit` 指路；两处 docstring 去名；能力清单成唯一口径（`DECISIONS §2026-09-25-goalnn-cloudflared-notebook-retired`）（2026-09-25） |
