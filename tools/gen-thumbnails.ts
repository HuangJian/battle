 ...
 *
 * Usage:
 *   bun tools/gen-thumbnails.ts --input generated-stages.json --output-dir thumbnails/
 *   bun tools/gen-thumbnails.ts --stages 0-4 --output-dir thumbnails/
 *   bun tools/gen-thumbnails.ts --generated --count 5 --output-dir thumbnails/
 */
