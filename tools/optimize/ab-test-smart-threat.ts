 ...
 *
 * Usage:
 *   bun tools/optimize/ab-test-smart-threat.ts --stage 32 --seeds 120
 *   bun tools/optimize/ab-test-smart-threat.ts --stage 6 --seeds 60
 *   bun tools/optimize/ab-test-smart-threat.ts --all --seeds 60   # all 35 stages
 */
