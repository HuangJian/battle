 ...
 *
 * Usage:
 *   bun tools/ai-calibrate.ts --seeds 10 --difficulty hard
 *   bun tools/ai-calibrate.ts --seeds 100 --difficulty all --pretty
 */

import { STAGES } from '../src/config/stages'
import { runSimulation } from './simulation-runner'
import { DEFAULT_GOD_AI_PARAMS, SKILLED_HUMAN_PARAMS, type GodAIParams } from '../src/ai/GodAIInput'
