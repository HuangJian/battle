 ...
 *
 * Usage:
 *   bun tools/batch-sim.ts --stages 0-4 --difficulty hard --seeds 1-5 --eval
 *   bun tools/batch-sim.ts --generated --count 10 --difficulty hard --seeds 1-3 --eval
 *   bun tools/batch-sim.ts --stages all --difficulty chaos --seeds 1-10 --eval --pretty
 */
