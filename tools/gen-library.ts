 ...
 *
 * Usage:
 *   bun tools/gen-library.ts --count 30 --difficulty hard --seeds 3 --output generated-stages.json
 *   bun tools/gen-library.ts --count 50 --difficulty chaos --theme mixed --seeds 5 --pretty
 */
