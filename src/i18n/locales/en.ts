...
export const en: Catalog = {
  ...
  // ---- Human-opening probe (dev launcher + session bar) ----
  'cc.probeLauncher': 'Probe Launcher',
  'cc.titleProbe': 'Human-opening probe — session runs (dev)',
  'probe.bar.title': 'PROBE',
  'probe.bar.exit': 'Exit probe',
  'probe.bar.prev': '◀ Prev',
  'probe.bar.retry': '↻ Retry',
  'probe.bar.next': 'Next ▶',
  'probe.bar.end': 'End session ⤓',
  'probe.bar.reason': 'Reason (required for “unsolvable”)',
  'probe.bar.game': 'Game {n}/{total}',
  'probe.bar.verdicts': '{n} judged',
  'probe.bar.stage': 'stage {stage} · seed {seed}',
  'probe.bar.ticks': '{ticks}/{max} ticks',
  'probe.bar.attempts': 'attempt {n}',
  'probe.bar.kills': 'kills {kills} · death t{deathTick}',
  'probe.bar.outcome.clear': 'CLEARED',
  'probe.bar.outcome.gameover': 'DIED',
  'probe.bar.outcome.timeout': 'TIMEOUT',
  'probe.band.solvable': 'Solvable',
  'probe.band.slight': 'Slight',
  'probe.band.tough': 'Tough',
  'probe.band.unsolvable': 'Unsolvable',
  'probe.band.retry': 'Retry',
}
