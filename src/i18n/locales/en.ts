...
export const en: Catalog = {
  ...
  'controls.tabPad': 'Gamepad',
  'controls.hint': 'Click a key, then press a new one',
  'controls.pressPadButton': 'Press a pad button…',
  'controls.padHint': 'Click a button, then press it on the gamepad',
  'controls.padActions.up': 'Pad Up (d-pad)',
  'controls.padActions.down': 'Pad Down (d-pad)',
  'controls.padActions.left': 'Pad Left (d-pad)',
  'controls.padActions.right': 'Pad Right (d-pad)',
  'controls.padActions.fire': 'Pad Fire',
