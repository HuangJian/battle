...
// ================================================================
// GamepadInput — gamepad support (DECISIONS §354)
//
...
//
// Standard-gamepad mapping (W3C mapping="standard"); §354a follow-up makes
 ...
 *
 * `bind` parametrizes the action→button mapping (§354a follow-up): a
...
export class GamepadInput implements InputLike {
  ...
  /**
   * LIVE bindings reference (§354a follow-up) — readSnapshot reads it on
...
export class GamepadManager {
  ...
  poll(): void {
    ...
    // both readSnapshot calls below must see the same mapping (§354a).
...
/**
 * First currently-pressed rebindable button in a snapshot, or null (§354a
