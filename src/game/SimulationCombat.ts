// ================================================================
// CombatSystem — extracted from the former SimulationCombat.ts mixin
...
/**
 * the Movement System (velocity / ice-momentum / tank
...
export class CombatSystem {
  ...
  private damageBase(bullet: Bullet): void {
    ...
    if (bp) {
      this.d.effects.createExplosion(bp.x + CELL, bp.y + CELL, 'small')
    }
    if (dmg >= w.baseHp) {
      w.baseHp = 0
