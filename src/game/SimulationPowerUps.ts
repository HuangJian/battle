...
/**
 * SimulationPowerUpsMixin — the Power-up System: drop construction (buildDrop /
 ...
 * mixin order. Cross-mixin calls (decoy, mine, explosions) resolve to the
 * stubs declared on `SimulationCore`.
 */
export function SimulationPowerUpsMixin<TBase extends SimulationConstructor<SimulationCore>>(
  Base: TBase,
) {
  return class SimulationPowerUps extends Base {
    // ================================================================
    // Power-up System
    // ================================================================
     ...
     */
    protected buildDrop(at?: { x: number; y: number }): {
      type: PowerUpType
      x: number
      y: number
    } {
    ...
    protected spawnPowerUp(at?: { x: number; y: number }): void {
