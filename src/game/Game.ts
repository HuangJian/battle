...
export class Game {
   ...
   * what the recorder taps (DECISIONS #75). Since §354 the live input is a
   ...
   * — §354): P1's composite wraps AutoFireInput when coop decorates the
  ...
  constructor(root: HTMLElement) {
    ...
    // loadSettings — see DECISIONS.md §353 follow-up.)
  ...
  /**
   * Drop all gamepad edge/held state (§354). Called when leaving a state
