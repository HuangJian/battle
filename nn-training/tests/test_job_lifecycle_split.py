...
def test_job_lifecycle_only_depends_downwards_and_stays_within_its_whitelist() -> None:
    ...
    """
    dag.assert_remote_module("remote.job_lifecycle", allowed_project_imports=ALLOWED_IMPORTS)
